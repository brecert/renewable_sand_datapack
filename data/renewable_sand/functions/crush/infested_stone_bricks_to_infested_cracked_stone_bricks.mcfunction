...
fill ~ ~-1 ~ ~ ~-1 ~ minecraft:infested_cracked_stone_bricks replace minecraft:infested_stone_bricks
...
say @s is crushing infested_stone_bricks_to_infested_cracked_stone_bricks.mcfunction
